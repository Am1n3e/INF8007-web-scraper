...
class WebCrawler(Crawler):
    def __init__(self, webpage_url: str, show_exception_tb: bool, trottle: int, disable_crawling: bool) -> None:
        ...
        """
        super().__init__(webpage_url, show_exception_tb, disable_crawling, trottle, WebScrapper)
